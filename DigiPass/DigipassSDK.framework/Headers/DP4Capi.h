...
#define DIGIPASS_SDK_VERSION "4.21.1"                 //!< DIGIPASS SDK current version<br/><br/>
...
#define STATUS_GENERATE_INVALID_OTP 3	             //!<  The DIGIPASS generates invalid OTP or invalid signature.
#define STATUS_PRE_ACTIVATED        4				 //!<  The DIGIPASS is pre-activated in multi-device activation mode. The license has been provisioned and the second activation step can be performed to provision the instance.<br/><br/>
...
#define CRYPTO_APPLICATION_INDEX_APP_8 8                 //!<  Index of the eighth crypto application
#define CRYPTO_APPLICATION_INDEX_APP_ACTIVATION 100      //!<  Index of the activation crypto application (for a multi-device activation purpose)<br/><br/>

#define LENGTH_STATIC_VECTOR_V7        56            //!< Static vector length when using a static vector version lower or equal to 7
#define LENGTH_STATIC_VECTOR_V8_MAX    958           //!< Static vector maximal length when using a static vector version higher or equal to 8
#define LENGTH_DYNAMIC_VECTOR_V7       56            //!< Dynamic vector length when using a static vector version lower or equal to 7
#define LENGTH_DYNAMIC_VECTOR_V8_MAX   306           //!< Dynamic vector maximal length when using a static vector version higher or equal to 8
...
#define LENGTH_AUTHENTICATION_MODE     2             //!< Authentication mode length
#define LENGTH_SECURE_CHANNEL_MESSAGE_HEADER 30      //!< Secure channel message header length
#define LENGTH_SECURE_CHANNEL_MESSAGE_FOOTER 16      //!< Secure channel message footer length
#define LENGTH_SECURE_CHANNEL_MESSAGE_MAX    4202    //!< Secure channel message maximal length
#define LENGTH_SECURE_CHANNEL_MESSAGE_BODY_MAX (LENGTH_SECURE_CHANNEL_MESSAGE_MAX - LENGTH_SECURE_CHANNEL_MESSAGE_HEADER - LENGTH_SECURE_CHANNEL_MESSAGE_FOOTER) //!< Secure channel message body maximal length
#define LENGTH_SECURE_CHANNEL_MESSAGE_NONCE  16      //!< Secure channel message nonce length<br/><br/>
...
#define PROPERTY_PASSWORD_CHECK_LEVEL 7                //!< Property used to get the password check level => 0 for no check, 1 for checksum and 2 for hashcode
...
#define PROPERTY_APP_AUTHENTICATION_MODE 47    		   //!< Property used to get the authentication mode used during the one-time password computation.
#define PROPERTY_MULTI_DEVICE_ACTIVATION_ENABLED 48    //!< Property used to know if the multi-device activation is enabled.
#define PROPERTY_DEVICE_ID_BITS_NUMBER 49              //!< Property used to get the number of bits to keep when truncating the hash of the device fingerprint to create the diversifier for the derivation.
#define PROPERTY_DEVICE_TYPE 50                        //!< Property used to get the type of the device when the multi-device license activation was done.
#define PROPERTY_SEQUENCE_NUMBER 51                    //!< Property used to get the sequence number, used for multiple instances per account.
#define PROPERTY_PAYLOAD_KEY_TYPE 52                   //!< Property used to get the type of payload key.
#define PROPERTY_SECURE_CHANNEL_ENABLED 53             //!< Property used to know if the secure channel feature is enabled.<br/>
#define PROPERTY_APP_SCORE_CAPABLE 54                  //!< Property used to know if a crypto application can generate score-based OTPs.<br/><br/>
#define PROPERTY_PIN_VERSION 55                        //!< Property used to get the PIN version.
...
#define CIPHER_MODE_CFB 3                            //!< CFB cipher mode
#define CIPHER_MODE_CTR 4							 //!< CTR cipher mode<br/><br/>

#define SECURE_CHANNEL_MESSAGE_TYPE_LICENSE_ACTIVATION  0     //!< The secure channel message is a multi-device license activation message.
#define SECURE_CHANNEL_MESSAGE_TYPE_INSTANCE_ACTIVATION 1     //!< The secure channel message is a multi-device instance activation message.
#define SECURE_CHANNEL_MESSAGE_TYPE_DEACTIVATION        2     //!< The secure channel message is a deactivation message.
#define SECURE_CHANNEL_MESSAGE_TYPE_REQUEST             3     //!< The secure channel message is a request message.
#define SECURE_CHANNEL_MESSAGE_TYPE_RESPONSE            4     //!< The secure channel message is a response message.
#define SECURE_CHANNEL_MESSAGE_TYPE_INFORMATION_MESSAGE 0x24  //!< The secure channel message is an information message.<br/><br/>

#define JAILBREAK_STATUS_NA     0                    //!< The jailbreak status is not applicable.
#define JAILBREAK_STATUS_SAFE   1                    //!< The jailbreak status is safe.
#define JAILBREAK_STATUS_UNSAFE 2                    //!< The jailbreak status is unsafe.<br/><br/>

#define SCORE_MIN 0                                  //!< Minimal value for a score when using the Client Score feature.
#define SCORE_MAX 7                                  //!< Maximal value for a score when using the Client Score feature.<br/><br/>

#define SECURE_CHANNEL_MESSAGE_PROTECTION_NONE 0x00        //!< The secure channel message is not protected.
#define SECURE_CHANNEL_MESSAGE_PROTECTION_HMAC_AESCTR 0x01 //!< The secure channel message is validated using HMAC-SHA256 and its payload is ciphered with AES-128-CTR.
#define SECURE_CHANNEL_MESSAGE_PROTECTION_HMAC 0x11        //!< The secure channel message is validated using HMAC-SHA256 and its payload is not ciphered.<br/><br/>
...
#define RETURN_CODE_SERIAL_NUMBER_NULL                                -4009 //!< The serial number is null
#define RETURN_CODE_SERIAL_NUMBER_SUFFIX_INCORRECT_LENGTH	          -4010 //!< The serial number suffix length is incorrect
#define RETURN_CODE_SERIAL_NUMBER_INCORRECT_LENGTH                    -4010 //!< The serial number length is incorrect
...
#define RETURN_CODE_NOT_PASSWORD_PROTECTED    	                      -4066 //!< The DIGIPASS is not password protected
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_NULL                       -4067 //!< The secure channel message is null
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_FORMAT           -4068 //!< The secure channel message format is incorrect
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_LENGTH           -4069 //!< The secure channel message length is incorrect
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_TYPE             -4070 //!< The secure channel message type is incorrect
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_SIGNATURE_INVALID          -4071 //!< The signature of the secure channel message is invalid
#define RETURN_CODE_JAILBREAK_STATUS_INVALID                          -4072 //!< The jailbreak status is invalid
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_STATIC_VECTOR_INCONSISTENT -4073 //!< The static vector contained in the secure channel message is not equal to the one provided as parameter
#define RETURN_CODE_PLATFORM_ACTIVATION_KEY_INVALID                   -4074 //!< The platform activation key is invalid because it cannot be validated against its checksum
#define RETURN_CODE_MULTI_DEVICE_ACTIVATION_DISABLED                  -4075 //!< The multi-device activation is disabled in the DIGIPASS settings
#define RETURN_CODE_LICENSE_INCORRECT                                 -4076 //!< The DIGIPASS license is incorrect
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_TARGET           -4077 //!< The secure channel message is not dedicated to the current DIGIPASS
#define RETURN_CODE_MULTI_DEVICE_ACTIVATION_ENABLED                   -4078 //!< The multi-device activation is enabled in the DIGIPASS settings
#define RETURN_CODE_SECURE_CHANNEL_DISABLED                           -4079 //!< The secure channel is disabled in the DIGIPASS settings
#define RETURN_CODE_CLIENT_SCORE_DISABLED                             -4080 //!< The Client Score feature is disabled
#define RETURN_CODE_SCORE_INVALID                                     -4081 //!< The score value must be between 0 and 7
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_BODY_NULL_OR_EMPTY         -4082 //!< The secure channel message body is null
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_BODY_INCORRECT_LENGTH      -4083 //!< The secure channel message body is too long
#define RETURN_CODE_SECURE_CHANNEL_MESSAGE_BODY_INCORRECT_FORMAT      -4084 //!< The secure channel message body is not hexadecimal
#define RETURN_CODE_PROTECTION_TYPE_NOT_SUPPORTED                     -4085 //!< The protection type is not supported
#define RETURN_CODE_UNKNOWN_ERROR                                     -4099 //!< An unknown error has occurred<br/><br/>
//--------------------------------------------------------------------------
//--- TYPES ----------------------------------------------------------------
//--------------------------------------------------------------------------
...
typedef struct
{
    ...
    vds_ascii nonce[LENGTH_SECURE_CHANNEL_MESSAGE_NONCE + 1];
    vds_ascii body[LENGTH_SECURE_CHANNEL_MESSAGE_BODY_MAX + 1];
    vds_ascii authenticationTag[LENGTH_SECURE_CHANNEL_MESSAGE_FOOTER + 1];
    vds_ascii rawData[LENGTH_SECURE_CHANNEL_MESSAGE_MAX + 1];
    vds_bool encrypted;
    vds_byte paddingFor8BytesMultiple[7];
...
#ifndef _DOC
#define DPSDK_ActivateOfflineWithFingerprint(...) UFTCVglOudTvjlaBwHGK(__VA_ARGS__)
#endif
/**
 ...
 * </ul>
 * \param staticVectorInput Static vector, contains the DIGIPASS settings, MANDATORY, from 182 to 1916 hexadecimal characters (112 characters if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 ...
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 ...
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 ...
 * 	<li>\ref RETURN_CODE_SERIAL_NUMBER_NULL if the serial number is null</li>
 *  <li>\ref RETURN_CODE_SERIAL_NUMBER_INCORRECT_LENGTH if the serial number is incorrect</li>
 *  <li>\ref RETURN_CODE_MULTI_DEVICE_ACTIVATION_ENABLED if the multi-device activation is enabled in the DIGIPASS settings</li>
...
#ifndef _DOC
#define DPSDK_ActivateOffline(...) gYrFuAdXzYYFvXhDogVT(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DPSDK_ActivateOnlineWithFingerprint(...) SwjdqwcfnQsuPAgicmlj(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_ActivateOnline(...) fnVCcoFjWrRfZZAbytOZ(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DPSDK_GenerateResponseOnly(...) hLIiQWRPnwpqkSKIfZvi(__VA_ARGS__)
#endif
/**
 ...
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION).<br/>Use \ref DPSDK_GetDynamicVectorLength to properly initialize the length of this parameter as its size may vary after a SDK update.
 ...
 * <br/>With standard activation, the platform fingerprint is OPTIONAL but strongly recommended, no specific length, must be null if not used. The platform fingerprint is used to perform the token derivation only if the {@link DigipassSDK#generateDerivationCode} has already been called. For a DIGIPASS created by a DIGIPASS SDK 4.0 (<=> {@link DigipassPropertiesResponse#getCreationVersion()} < 3), the platform fingerprint is used to perform the token derivation even if if the {@link DigipassSDK#generateDerivationCode} has not been called.
...
#ifndef _DOC
#define DPSDK_GenerateResponseFromChallenge(...) QqTODMLlqXnOhsAIhIQF(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GenerateSignature(...) cOujwkUKVFHEWMTbnGnv(__VA_ARGS__)
#endif
/**
 * Signature process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_IsPasswordWeak(...) pqZaNMosnqAcYwyCzKOb(__VA_ARGS__)
#endif
/**
 ...
 * <li>The difference between each consecutive characters is constant. If the password is decimal, a modulo 10 is applied on each computed difference.</li>
 * </ul>
 */
SDK_IMPORT(vds_bool) DPSDK_IsPasswordWeak(vds_ascii* password);

#ifndef _DOC
#define DPSDK_ValidatePasswordWithFingerprint(...) IIUOUTnoFBCKEdgnZOOY(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_ValidatePassword(...) nwgjWyVSgGQaAGTFJJBU(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DPSDK_ChangePasswordWithFingerprint(...) CnQLPBZiOMpaSnMlASSm(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_ChangePassword(...) RUdmuqdXHrZpwPGCPmzi(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DPSDK_ActivateOfflineWithKey(...) GozVzLQTFSYvMPCZGGtz(__VA_ARGS__)
#endif
/**
 * Offline activation / reactivation process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_ActivateOnlineWithKey(...) YlivVmdMrVcGneaWTIcu(__VA_ARGS__)
#endif
/**
 * Online activation / reactivation process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_GenerateResponseOnlyWithKey(...) QaMGXsOVYlmctvxyQuOy(__VA_ARGS__)
#endif
/**
 * Response Only process:
 * <ul>
 ...
 * \param clientServerTimeShift Client/Server time shift in seconds, OPTIONAL, recommended if the application to use is time-based, else must be 0, use \ref DPSDK_ComputeClientServerTimeShiftFromServerTime to compute this value
 * \param cryptoApplicationIndex Crypto application index, indicates which application must be used to generate the response, MANDATORY, from \ref CRYPTO_APPLICATION_INDEX_APP_1 to \ref CRYPTO_APPLICATION_INDEX_APP_8
 * \param platformFingerprint Platform fingerprint used for token derivation if supported.
 * <br/>With standard activation, the platform fingerprint is OPTIONAL but strongly recommended, no specific length, must be null if not used. The platform fingerprint is used to perform the token derivation only if the {@link DigipassSDK#generateDerivationCode} has already been called. For a DIGIPASS created by a DIGIPASS SDK 4.0 (<=> {@link DigipassPropertiesResponse#getCreationVersion()} < 3), the platform fingerprint is used to perform the token derivation even if if the {@link DigipassSDK#generateDerivationCode} has not been called.
 * <br/>With multi-device activation, the platform fingerprint is MANDATORY.
 * \param response OUTPUT PARAMETER Generated response (OTP), characters array null terminated, MANDATORY
 * \param responseLength Length of the supplied "response" parameter, (\ref LENGTH_RESPONSE_MAX + 1) characters
...
#ifndef _DOC
#define DPSDK_GenerateResponseFromChallengeWithKey(...) WGEZxxGRAcECeEJJFTOD(__VA_ARGS__)
#endif
/**
 * Challenge Response process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_GenerateSignatureWithKey(...) QPzKeYIkaXNMSOabgbjZ(__VA_ARGS__)
#endif
/**
 * Signature process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_ChangeEncryptionKey(...) cJqhccebjfCpTszxFUoe(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GenerateResponseOnlyES(...) NEAuRpbtFwJcEXHmctod(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GenerateResponseFromChallengeES(...) vbqNRHcxKbSkNArPQSnl(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GenerateSignatureES(...) WoNfROBvmtzBmaptUnQJ(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GenerateResponseOnlyESWithKey(...) utCcsXPUbpvGAgyjfROR(__VA_ARGS__)
#endif
/**
 * Response Only process with enhanced security:
 * <ul>
...
#ifndef _DOC
#define DPSDK_GenerateResponseFromChallengeESWithKey(...) gqBVHIdDFBxbwhOdAsbk(__VA_ARGS__)
#endif
/**
 * Challenge Response process with enhanced security:
 * <ul>
...
#ifndef _DOC
#define DPSDK_GenerateSignatureESWithKey(...) hGrxuRqwYPDxLyJbKpJu(__VA_ARGS__)
#endif
/**
 * Signature process with enhanced security:
 * <ul>
...
#ifndef _DOC
#define DPSDK_ActivateOfflineDPPlusWithFingerprint(...) BoTWDntDSSZJmYKslySe(__VA_ARGS__)
#endif
/**
 * Offline activation / reactivation process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_ActivateOfflineDPPlus(...) MBZMwIjFtDjWnAfwdHrd(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DPSDK_ActivateOfflineDPPlusWithKey(...) GlutnDzGtQAfFudqpBEF(__VA_ARGS__)
#endif
/**
 * Offline activation / reactivation process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_ActivateOnlineDPPlusWithFingerprint(...) zlYRMEHcFegdsatoMdcM(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_ActivateOnlineDPPlus(...) uKPIWThflodmPtJHBpmZ(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DPSDK_ActivateOnlineDPPlusWithKey(...) hFixCNvtboxJmgGADsto(__VA_ARGS__)
#endif
/**
 * DP+ online activation / reactivation process:
 * <ul>
...
/////////////////////////////////////////////////////////////////
/////                                                       /////
/////  MULTI-DEVICE ACTIVATION AND SECURE CHANNEL METHODS   /////
/////                                                       /////
/////////////////////////////////////////////////////////////////

#ifndef _DOC
#define DPSDK_ParseSecureChannelMessage(...) JRCeQEEuFNZPvnlFBBMF(__VA_ARGS__)
#endif
/**
 * Parse a secure channel message.
 * \param message Content of the secure channel message, MANDATORY, from 46 to 1070 hexadecimal characters, MANDATORY
 * \param secureChannelMessage OUTPUT PARAMETER Secure channel message generated, MANDATORY
 * \return A code indicating the process result.
 * <ul>
 *  <li>\ref RETURN_CODE_SUCCESS in case of success</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_NULL if the secure channel message is null</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_FORMAT if the secure channel message format is incorrect</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_LENGTH if the secure channel message length is incorrect</li>
 *  <li>\ref RETURN_CODE_OUTPUT_DATA_NULL if the secure channel message structure is null</li>
 *  <li>\ref RETURN_CODE_UNKNOWN_ERROR if an unknown error has occurred</li>
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_ParseSecureChannelMessage(vds_ascii* message,
        SecureChannelMessage* secureChannelMessage);

#ifndef _DOC
#define DPSDK_MultiDeviceActivateLicense(...) TzTQWPCsAtvhhdzWffuA(__VA_ARGS__)
#endif
/**
 ...
 * </ul>
 * \param secureChannelMessage Secure channel message, contains the license activation data, MANDATORY, see \ref DPSDK_ParseSecureChannelMessage
 * \param staticVectorInput Static vector, contains the DIGIPASS settings, OPTIONAL, from 182 to 1916 hexadecimal characters
 * \param platformFingerprint Platform fingerprint used to generate the device code, MANDATORY, no specific length
 * \param jailbreakStatus Jailbreak status, see \ref JAILBREAK_STATUS_NA, \ref JAILBREAK_STATUS_SAFE and \ref JAILBREAK_STATUS_UNSAFE
 * \param clientServerTimeShift RFU
 * \param staticVectorOutput OUTPUT PARAMETER Static vector generated during the multi-device license activation process, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param dynamicVector OUTPUT PARAMETER Dynamic vector generated during the multi-device license activation process and ready to be stored, contains the DIGIPASS data, MANDATORY.<br/>
 * For an activation purpose, supply a zero valued bytes array (memset with 0).<br/>
 * For a reactivation purpose, supply the dynamic vector previously stored.
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param deviceCode OUTPUT PARAMETER The generated device code
 * \param devideCodeLength Length of the supplied "deviceCode" parameter, (\ref LENGTH_DERIVATION_CODE_MAX + 1) characters
 * \return A code indicating the process result.
 * <ul>
 *  <li>\ref RETURN_CODE_SUCCESS in case of success</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_NULL if the secure channel message is null</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_TYPE if the secure channel message is not a multi-device license activation message</li>
 *  <li>\ref RETURN_CODE_JAILBREAK_STATUS_INVALID if the jailbreak status is invalid</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_NULL if the static vector is null as parameter and in the secure channel message</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_INCORRECT_LENGTH if the static vector length is incorrect</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_INCORRECT_FORMAT if the static vector format is incorrect</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_STATIC_VECTOR_INCONSISTENT if the static vector contained in the secure channel message is not equal to the one provided as parameter</li>
 *  <li>\ref RETURN_CODE_DYNAMIC_VECTOR_NULL if the dynamic vector is null</li>
 *  <li>\ref RETURN_CODE_DYNAMIC_VECTOR_INCORRECT_LENGTH if the dynamic vector length is incorrect</li>
 *  <li>\ref RETURN_CODE_MULTI_DEVICE_ACTIVATION_DISABLED if the multi-device activation is disabled in the DIGIPASS settings</li>
 *  <li>\ref RETURN_CODE_PLATFORM_ACTIVATION_KEY_INVALID if the platform activation key is invalid because it cannot be validated against its checksum</li>
 *  <li>\ref RETURN_CODE_PLATFORM_FINGERPRINT_NOT_DEFINED if the platform fingerprint is not defined</li>
 *  <li>\ref RETURN_CODE_DERIVATION_CODE_NULL if the deviceCode parameter is null</li>
 *  <li>\ref RETURN_CODE_DERIVATION_CODE_INCORRECT_LENGTH if the deviceCode parameter length is incorrect</li>
 *  <li>\ref RETURN_CODE_UNKNOWN_ERROR if an unknown error has occurred</li>
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_MultiDeviceActivateLicense(SecureChannelMessage* secureChannelMessage,
        vds_ascii* staticVectorInput,
        vds_ascii* platformFingerprint,
        vds_byte jailbreakStatus,
        vds_int32 clientServerTimeShift,
        vds_byte* staticVectorOutput,
        vds_int32* staticVectorLength,
        vds_byte* dynamicVector,
        vds_int32* dynamicVectorLength,
        vds_ascii* deviceCode,
        vds_int32 deviceCodeLength);

#ifndef _DOC
#define DPSDK_MultiDeviceActivateInstance(...) hwuPRoEwcDbzOaojCxia(__VA_ARGS__)
#endif
/**
 ...
 * \param dynamicVector Dynamic vector, contains the DIGIPASS data, MANDATORY, <b>must be stored after the call</b>
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param secureChannelMessage Secure channel message, contains the instance activation data, MANDATORY, see \ref DPSDK_ParseSecureChannelMessage
 * \param password Password used to encrypt DIGIPASS secrets, MANDATORY if the password is required in the DIGIPASS settings (see \ref DPSDK_GetDigipassProperty)
 * \param platformFingerprint Platform fingerprint used for the secrets encryption, MANDATORY, no specific length
 * \return A code indicating the process result.
 * <ul>
 *  <li>\ref RETURN_CODE_SUCCESS in case of success</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_NULL if the secure channel message is null</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_TYPE if the secure channel message is not a multi-device instance activation message</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_SIGNATURE_INVALID if the signature of the secure channel message is invalid</li>
 *  <li>\ref RETURN_CODE_PLATFORM_FINGERPRINT_NOT_DEFINED if the platform fingerprint is not defined</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_NULL if the static vector is null</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_INCORRECT_LENGTH if the static vector length is incorrect</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_INCORRECT_FORMAT if the static vector format is incorrect</li>
 ...
 *  <li>\ref RETURN_CODE_DYNAMIC_VECTOR_INCORRECT_FORMAT if the dynamic vector format is incorrect</li>
 *  <li>\ref RETURN_CODE_MULTI_DEVICE_ACTIVATION_DISABLED if the multi-device activation is disabled in the DIGIPASS settings</li>
 *  <li>\ref RETURN_CODE_STATUS_INVALID if the DIGIPASS status is not \ref STATUS_PRE_ACTIVATED</li>
 *  <li>\ref RETURN_CODE_LICENSE_INCORRECT if the DIGIPASS license is incorrect</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_TARGET if the secure channel message is not dedicated to the current DIGIPASS</li>
 *  <li>\ref RETURN_CODE_PASSWORD_NULL if the password is null</li>
 *  <li>\ref RETURN_CODE_PASSWORD_LENGTH_TOO_SHORT if the password is too short</li>
 *  <li>\ref RETURN_CODE_PASSWORD_LENGTH_TOO_LONG if the password is too long</li>
 *  <li>\ref RETURN_CODE_PASSWORD_WEAK if the password is weak</li>
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_MultiDeviceActivateInstance(vds_byte* staticVector,
        vds_int32 staticVectorLength,
        vds_byte* dynamicVector,
        vds_int32 dynamicVectorLength,
        SecureChannelMessage* secureChannelMessage,
...
#ifndef _DOC
#define DPSDK_MultiDeviceActivateInstanceWithKey(...) hXQmDaEOGOxgbFNTcuts(__VA_ARGS__)
#endif
/**
 ...
 * \param dynamicVector Dynamic vector, contains the DIGIPASS data, MANDATORY, <b>must be stored after the call</b>
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param secureChannelMessage Secure channel message, contains the activation data, MANDATORY, see \ref DPSDK_ParseSecureChannelMessage
 * \param encryptionKey Encryption key used to decrypt the DIGIPASS secrets, MANDATORY
 * \param encryptionKeyLength 16 bytes
 * \param platformFingerprint Platform fingerprint used for the secrets encryption, MANDATORY, no specific length
 * \return A code indicating the process result.
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_MultiDeviceActivateInstanceWithKey(vds_byte* staticVector, vds_int32 staticVectorLength,
        vds_byte* dynamicVector,
        vds_int32 dynamicVectorLength,
        SecureChannelMessage* secureChannelMessage,
        vds_byte* encryptionKey,
...
#ifndef _DOC
#define DPSDK_DecryptSecureChannelMessageBody(...) xSVQiooZaRMCzdeXHZBx(__VA_ARGS__)
#endif
/**
 ...
 * \param dynamicVector Dynamic vector, contains the DIGIPASS data, MANDATORY, <b>must be stored after the call</b>
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param secureChannelMessage Secure channel message, MANDATORY, not a  multi-device license activation message nor a multi-device instance activation message, see \ref DPSDK_ParseSecureChannelMessage, \ref SECURE_CHANNEL_MESSAGE_TYPE_LICENSE_ACTIVATION and \ref SECURE_CHANNEL_MESSAGE_TYPE_INSTANCE_ACTIVATION
 * \param platformFingerprint Platform fingerprint used for the secrets encryption, MANDATORY, no specific length
 * \param messageBody OUTPUT PARAMETER The secure channel message body
 * \param messageBodyLength Length of the supplied "messageBody" parameter, (\ref LENGTH_SECURE_CHANNEL_MESSAGE_BODY_MAX + 1) characters
 * \return A code indicating the process result.
 * <ul>
 *  <li>\ref RETURN_CODE_SUCCESS in case of success</li>
 *  <li>\ref RETURN_CODE_OUTPUT_DATA_NULL if the message body is NULL</li>
 *  <li>\ref RETURN_CODE_OUTPUT_DATA_INCORRECT_LENGTH if the length of the message body is incorrect</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_NULL if the secure channel message is null</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_TYPE if the secure channel message is a multi-device license activation message or a multi-device instance activation message</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_SIGNATURE_INVALID if the signature of the secure channel message is invalid</li>
 *  <li>\ref RETURN_CODE_PLATFORM_FINGERPRINT_NOT_DEFINED if the platform fingerprint is not defined</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_NULL if the static vector is null</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_INCORRECT_LENGTH if the static vector length is incorrect</li>
 ...
 *  <li>\ref RETURN_CODE_MULTI_DEVICE_ACTIVATION_DISABLED if the multi-device activation is disabled in the DIGIPASS settings</li>
 *  <li>\ref RETURN_CODE_LICENSE_INCORRECT if the DIGIPASS license is incorrect</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_DISABLED if the secure channel is disabled in the DIGIPASS settings</li>
 *  <li>\ref RETURN_CODE_STATUS_INVALID if the DIGIPASS cannot be be used because of its status (not activated or locked)</li>
 *  <li>\ref RETURN_CODE_UNKNOWN_ERROR if an unknown error has occurred</li>
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_DecryptSecureChannelMessageBody(vds_byte* staticVector,
        vds_int32 staticVectorLength,
        vds_byte* dynamicVector,
        vds_int32 dynamicVectorLength,
        SecureChannelMessage* secureChannelMessage,
        vds_ascii* platformFingerprint,
        vds_ascii* messageBody,
        vds_int32 messageBodyLength);

#ifndef _DOC
#define DPSDK_GenerateSignatureFromSecureChannelMessage(...) MhJnkKXWpoPXTkxOlhaQ(__VA_ARGS__)
#endif
/**
 * Generates a signature from the secure channel message with a password.
 * \param staticVector Static vector, contains the DIGIPASS settings, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param dynamicVector Dynamic vector, contains the DIGIPASS data, MANDATORY, <b>must be stored after the call</b>
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION). <br/>Use \ref DPSDK_GetDynamicVectorLength to properly initialize the length of this parameter as its size may vary after a SDK update.
 * \param secureChannelMessage Secure channel message of activation or request type, MANDATORY, see \ref DPSDK_ParseSecureChannelMessage, \ref SECURE_CHANNEL_MESSAGE_TYPE_INSTANCE_ACTIVATION and \ref SECURE_CHANNEL_MESSAGE_TYPE_REQUEST
 * \param password Password used to decrypt DIGIPASS secrets, MANDATORY if the password is required in the DIGIPASS settings (see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_PASSWORD_PROTECTED)
 * \param clientServerTimeShift Client/Server time shift in seconds, OPTIONAL, recommended if the application to use is time-based, else must be 0, use \ref DPSDK_computeClientServerTimeShiftFromServerTime(long) to compute this value
 * \param cryptoApplicationIndex Crypto application index, indicates which application must be used to generate the response, MANDATORY, from \ref CRYPTO_APPLICATION_INDEX_APP_1 to \ref CRYPTO_APPLICATION_INDEX_APP_8
 * \param platformFingerprint Platform fingerprint used for the secrets encryption, MANDATORY, no specific length
 * \param response OUTPUT PARAMETER Generated response (OTP), characters array null terminated, MANDATORY
 * \param responseLength Length of the supplied "response" parameter, (\ref LENGTH_RESPONSE_MAX + 1) characters
 ...
 *  <li>\ref RETURN_CODE_SUCCESS in case of success</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_NULL if the secure channel message is null</li>
 *  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_INCORRECT_TYPE if the secure channel message is not an activation or a request message</li>
 *  <li>\ref RETURN_CODE_PROTECTION_TYPE_NOT_SUPPORTED if the secure channel message signature has no protection type</li>
 *  <li>\ref RETURN_CODE_PLATFORM_FINGERPRINT_NOT_DEFINED if the platform fingerprint is not defined</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_NULL if the static vector is null</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_INCORRECT_LENGTH if the static vector length is incorrect</li>
 *  <li>\ref RETURN_CODE_STATIC_VECTOR_INCORRECT_FORMAT if the static vector format is incorrect</li>
 ...
 *  <li>\ref RETURN_CODE_PASSWORD_WRONG if the password is cannot be validated</li>
 *  <li>\ref RETURN_CODE_NOT_PASSWORD_PROTECTED if the DIGIPASS is not password protected</li>
 *  <li>\ref RETURN_CODE_CRYPTO_APPLICATION_INDEX_INVALID if the crypto application index is invalid</li>
 *  <li>\ref RETURN_CODE_APPLICATION_DISABLED if the crypto application is disabled in the Digipass settings</li>
 *  <li>\ref RETURN_CODE_CHALLENGE_CHARACTER_INVALID if one of the data to sign contains invalid characters</li>
 *  <li>\ref RETURN_CODE_DATA_FIELDS_NUMBER_INVALID if the number of data fields to sign is incorrect</li>
 *  <li>\ref RETURN_CODE_DATA_FIELD_INCORRECT_LENGTH if one of the data fields to sign length is incorrect </li>
 *  <li>\ref RETURN_CODE_UNKNOWN_ERROR if an unknown has occurred</li>
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_GenerateSignatureFromSecureChannelMessage(vds_byte* staticVector,
        vds_int32 staticVectorLength,
        vds_byte* dynamicVector,
        vds_int32 dynamicVectorLength,
        SecureChannelMessage* secureChannelMessage,
...
#ifndef _DOC
#define DPSDK_GenerateSignatureFromSecureChannelMessageWithKey(...) TnPGwiswBIeZVYJlulVY(__VA_ARGS__)
#endif
/**
 * Generates a signature from the secure channel message with an encryption key.
 * \param staticVector Static vector, contains the DIGIPASS settings, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param dynamicVector Dynamic vector, contains the DIGIPASS data, MANDATORY, <b>must be stored after the call</b>
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION). <br/>Use \ref DPSDK_GetDynamicVectorLength to properly initialize the length of this parameter as its size may vary after a SDK update.
 ...
 * \param encryptionKeyLength Length of encryption key
 * \param clientServerTimeShift Client/Server time shift in seconds, OPTIONAL, recommended if the application to use is time-based, else must be 0, use \ref DPSDK_computeClientServerTimeShiftFromServerTime(long) to compute this value
 * \param cryptoApplicationIndex Crypto application index, indicates which application must be used to generate the response, MANDATORY, from \ref CRYPTO_APPLICATION_INDEX_APP_1 to \ref CRYPTO_APPLICATION_INDEX_APP_8
 * \param platformFingerprint Platform fingerprint used for the secrets encryption, MANDATORY, no specific length
 * \param response OUTPUT PARAMETER Generated response (OTP), characters array null terminated, MANDATORY
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_GenerateSignatureFromSecureChannelMessageWithKey(vds_byte* staticVector,
        vds_int32 staticVectorLength,
        vds_byte* dynamicVector,
        vds_int32 dynamicVectorLength,
        SecureChannelMessage* secureChannelMessage,
...
#ifndef _DOC
#define DPSDK_GenerateSecureChannelInformationMessage(...) SJhmnoohCQoYgwJJLkyN(__VA_ARGS__)
#endif
/**
...
* <ul>
*  <li>\ref SECURE_CHANNEL_MESSAGE_PROTECTION_NONE, the message is not protected.</li>
*  <li>\ref SECURE_CHANNEL_MESSAGE_PROTECTION_HMAC_AESCTR, HMAC-SHA256 along with AES-CTR are used to guarantee data origin authentication and confidentiality</li>
* </ul>
...
*  <li>\ref RETURN_CODE_SUCCESS in case of success</li>
*  <li>\ref RETURN_CODE_PLATFORM_FINGERPRINT_NOT_DEFINED if the platform fingerprint is not defined</li>
*  <li>\ref RETURN_CODE_PROTECTION_TYPE_NOT_SUPPORTED if the protection type is neither \ref SECURE_CHANNEL_MESSAGE_PROTECTION_NONE nor \ref SECURE_CHANNEL_MESSAGE_PROTECTION_HMAC_AESCTR</li>
*  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_BODY_NULL if the secure channel message body is null</li>
*  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_BODY_INCORRECT_FORMAT if the secure channel message body is not an hexadecimal string</li>
*  <li>\ref RETURN_CODE_SECURE_CHANNEL_MESSAGE_BODY_INCORRECT_LENGTH if the secure channel message body does no have an even length or is longer than 1024 hexadecimal characters</li>
*  <li>\ref RETURN_CODE_SECURE_CHANNEL_DISABLED if the secure channel is disabled in the DIGIPASS settings</li>
*  <li>\ref RETURN_CODE_UNKNOWN_ERROR if an unknown error has occurred</li>
* </ul>
*/
SDK_IMPORT(vds_int32) DPSDK_GenerateSecureChannelInformationMessage(vds_byte* staticVector,
        vds_int32 staticVectorLength,
        vds_byte* dynamicVector,
        vds_int32 dynamicVectorLength,
		vds_ascii* secureChannelMessageBody,
		vds_byte protectionType,
		vds_ascii* platformFingerprint,
		SecureChannelMessage* secureChannelMessage);
...
#ifndef _DOC
#define DPSDK_GenerateResponseOnlyWithScore(...) GSzhFtiZgwfmWjlTdIYx(__VA_ARGS__)
#endif
/**
 * Response Only process:
 * <ul>
 *  <li>It validates the password.</li>
 *  <li>It generates a score-based OTP.</li>
 *  <li>It updates the application data (status and counters) according to the validation and generation results.</li>
 * </ul>
 * \param staticVector Static vector, contains the DIGIPASS settings, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 ...
 * \param score Score generated by the Client Score SDK, between 0 and 7
 * \param response OUTPUT PARAMETER Generated response (OTP), characters array null terminated, MANDATORY
 * \param responseLength Length of the supplied "response" parameter, (\ref LENGTH_RESPONSE_MAX + 1) characters
 * \param hostCode OUTPUT PARAMETER Generated host code, characters array null terminated, MANDATORY if host code must be generated for the selected crypto application (see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_APP_HOST_CODE_LENGTH)
 * \param hostCodeLength Length of the supplied "hostCode" parameter, (\ref LENGTH_HOST_CODE_MAX + 1) characters
 ...
 * 	<li>\ref RETURN_CODE_HOST_CODE_NULL if the hostCode parameter is null</li>
 * 	<li>\ref RETURN_CODE_HOST_CODE_INCORRECT_LENGTH if the hostCode parameter length is incorrect</li>
 *  <li>\ref RETURN_CODE_CLIENT_SCORE_DISABLED if the Client Score feature is disabled</li>
 *  <li>\ref RETURN_CODE_SCORE_INVALID if the score value is not between 0 and 7</li>
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_GenerateResponseOnlyWithScore(vds_byte* staticVector,
	vds_int32 staticVectorLength,
	vds_byte* dynamicVector,
	vds_int32 dynamicVectorLength,
	vds_ascii* password,
...
#ifndef _DOC
#define DPSDK_GenerateResponseFromChallengeWithScore(...) jTpziMFMKDoUEQYoksmt(__VA_ARGS__)
#endif
/**
 * Challenge Response process:
 * <ul>
 *  <li>It validates the password.</li>
 *  <li>It generates a score_based response by signing the challenge.</li>
 *  <li>It updates the application data (status and counters) according to the validation and generation results.</li>
 * </ul>
 * \param staticVector Static vector, contains the DIGIPASS settings, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_GenerateResponseFromChallengeWithScore(vds_byte* staticVector,
	vds_int32 staticVectorLength,
	vds_byte* dynamicVector,
	vds_int32 dynamicVectorLength,
	vds_ascii* challenge,
...
#ifndef _DOC
#define DPSDK_GenerateSignatureWithScore(...) xVAPlocsYHSRNknNKccZ(__VA_ARGS__)
#endif
/**
 * Signature process:
 * <ul>
 *  <li>It validates the password.</li>
 *  <li>It generates a score-based signature by signing the data fields.</li>
 *  <li>It updates the application data (status and counters) according to the validation and generation results.</li>
 * </ul>
 * \param staticVector Static vector, contains the DIGIPASS settings, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_GenerateSignatureWithScore(vds_byte* staticVector,
	vds_int32 staticVectorLength,
	vds_byte* dynamicVector,
	vds_int32 dynamicVectorLength,
	vds_ascii dataFields[NUMBER_DATA_FIELD_MAX][LENGTH_DATA_FIELD_MAX + 1],
...
#ifndef _DOC
#define DPSDK_GenerateSignatureFromSecureChannelMessageWithScore(...) jGYUjgpXgAKWJCUdwMGq(__VA_ARGS__)
#endif
/**
 * Generates a score_based signature from the secure channel message with a password.
 * \param staticVector Static vector, contains the DIGIPASS settings, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 * \param dynamicVector Dynamic vector, contains the DIGIPASS data, MANDATORY, <b>must be stored after the call</b>
 * \param dynamicVectorLength From 80 to 303 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION). <br/>Use \ref DPSDK_GetDynamicVectorLength to properly initialize the length of this parameter as its size may vary after a SDK update.
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_GenerateSignatureFromSecureChannelMessageWithScore(vds_byte* staticVector,
	vds_int32 staticVectorLength,
	vds_byte* dynamicVector,
	vds_int32 dynamicVectorLength,
	SecureChannelMessage* secureChannelMessage,
...
#define DPSDK_ActivateOfflineEmbedded(...) ehHAafyhBOrqLbTzENnI(__VA_ARGS__)
/**
 * Offline activation / reactivation process:
 * <ul>
 *  <li>Parses the DIGIPASS settings.</li>
...
#define DPSDK_ActivateOfflineDPPlusEmbedded(...) cReHnEgBFUukTGftsjqs(__VA_ARGS__)
/**
...
#define DPSDK_ActivateOnlineEmbedded(...) oSirjwRyktevKPYHXYvM(__VA_ARGS__)
/**
 * Online activation / reactivation process:
 * <ul>
 *  <li>Extracts the activation data from the XFAD.</li>
...
#define DPSDK_ActivateOnlineDPPlusEmbedded(...) JAbWMIcjetUwbHMXALnd(__VA_ARGS__)
/**
 * Online activation / reactivation process:
 * <ul>
 *  <li>Extracts the activation data from the XFAD.</li>
...
#define DPSDK_GenerateResponseOnlyEmbedded(...) vPPigRQxFMKzgqbYrcWF(__VA_ARGS__)
/**
 * Response Only process:
 * <ul>
...
#define DPSDK_GenerateResponseFromChallengeEmbedded(...) AiVjjZbJsmgZDUaWTBpw(__VA_ARGS__)
/**
 * Challenge Response process:
 * <ul>
...
#define DPSDK_GenerateSignatureEmbedded(...) rzQPWLAaHjYmQSWEQNiz(__VA_ARGS__)
/**
 * Signature process:
 * <ul>
...
#ifndef _DOC
#define DPSDK_Hash(...) fBcwkKFjTPJbVdaRNquP(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_Encrypt(...) tcqObFaCMyxlGjXxEBNE(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_Decrypt(...) jrsxYnJUzWKrxbRFthnw(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_EnableApplication(...) UEYVRdQGDAayQmNseTCN(__VA_ARGS__)
#endif
/**
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_EnableApplication(vds_byte* staticVector,
		vds_int32 staticVectorLength,
		vds_byte* dynamicVector,
		vds_int32 dynamicVectorLength,
		vds_int32 cryptoApplicationIndex);
...
#ifndef _DOC
#define DPSDK_DisableApplication(...) LOXxVBereethwNXXokWn(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GenerateDerivationCode(...) eMpNARTKBwbzIvzzKxEU(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GenerateDerivationCodeWithKey(...) kvzhvhFfNRXxrsSvpfVN(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GetDynamicVectorLength(...) XyrbmbgzCVsRqfdyTTLV(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_GetDigipassProperty(...) FLcvbewwBOWyqVzmLhlN(__VA_ARGS__)
#endif
/**
 * Gets a DIGIPASS property from the static and dynamic vectors
 * \param staticVector Static vector, contains the DIGIPASS settings, MANDATORY
 * \param staticVectorLength From 91 to 958 bytes (56 if static vector version < 8, see \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION)
 ...
 *  <tr> <td>PROPERTY_SERIAL_NUMBER</td>                    <td>vds_ascii*</td>  <td>LENGTH_SERIAL_NUMBER + 1</td>                 <td>false</td> </tr>
 ...
 *  <tr> <td>PROPERTY_APP_ENABLED</td>                      <td>vds_bool*</td>   <td>sizeof(vds_bool)</td>                         <td>false</td> </tr>
 ...
 *  <tr> <td>PROPERTY_MULTI_DEVICE_ACTIVATION_ENABLED</td>  <td>vds_bool*</td>   <td>sizeof(vds_bool)</td>                         <td>false</td> </tr>
 *  <tr> <td>PROPERTY_DEVICE_ID_BITS_NUMBER</td>            <td>vds_byte*</td>   <td>sizeof(vds_byte)</td>                         <td>false</td> </tr>
 *  <tr> <td>PROPERTY_DEVICE_TYPE</td>                      <td>vds_byte*</td>   <td>sizeof(vds_byte)</td>                         <td>true</td>  </tr>
 *  <tr> <td>PROPERTY_SEQUENCE_NUMBER</td>                  <td>vds_byte*</td>   <td>sizeof(vds_byte)</td>                         <td>true</td>  </tr>
 *  <tr> <td>PROPERTY_PAYLOAD_KEY_TYPE</td>                 <td>vds_byte*</td>   <td>sizeof(vds_byte)</td>                         <td>true</td>  </tr>
 *  <tr> <td>PROPERTY_SECURE_CHANNEL_ENABLED</td>           <td>vds_bool*</td>   <td>sizeof(vds_bool)</td>                         <td>true</td>  </tr>
 *  <tr> <td>PROPERTY_APP_SCORE_CAPABLE</td>                <td>vds_bool*</td>   <td>sizeof(vds_bool)</td>                         <td>false</td> </tr>
 *  <tr> <td>PROPERTY_PIN_VERSION</td>                      <td>vds_byte*</td>   <td>sizeof(vds_byte)</td>                         <td>true</td>  </tr>
 * </table>
 */
...
#ifndef _DOC
#define DPSDK_GetDigipassPropertyFromXFAD(...) VceVmMQLPOvBvRabgzhn(__VA_ARGS__)
#endif
/**
 * Gets a DIGIPASS property from XFAD
 * \param xfad Encrypted Full Activation Data, contains the activation data, MANDATORY, from 205 to 1738 hexadecimal characters (from 139 to 166 characters if static vector version < 8, see  \ref DPSDK_GetDigipassProperty and \ref PROPERTY_VERSION))
 * \param property Required property, see \ref DPSDK_GetDigipassProperty for more details concerning the available properties
 * \param value OUTPUT PARAMETER Value associated with the specified property, find below the list of the required type for each property
 * \param valueLength Value length, find below the list of the required length for each property
 * \param cryptoApplicationIndex  Crypto application index, indicates which application must be used to get a property associated with an application (<=> PROPERTY_APP_xxx)
 * \return A code indicating the process result.
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_GetDigipassPropertyFromXFAD(vds_ascii* xfad,
		vds_int32 property,
		void* value,
		vds_int32 valueLength,
		vds_int32 cryptoApplicationIndex);
...
#ifndef _DOC
#define DPSDK_GetMessageForReturnCode(...) QMTpjfQaxUIIUKwEIkKu(__VA_ARGS__)
#endif
/**
...
#ifndef _DOC
#define DPSDK_ComputeClientServerTimeShiftFromServerTime(...) ACdvYdwnXvIsmklLDhnw(__VA_ARGS__)
#endif
/**
...
#if !defined(_DP4IPHONE) && !defined(_DP4BBN) && !defined(_DP4TEST)
...
/*================= Activation Offline =================*/
#ifndef _DOC
#define DP4C_Activate(...) DrEaQVirhXPVvgnuMHgl(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_ActivateOfflineWithFingerprint or \ref DPSDK_ActivateOfflineWithKey.
...
#ifndef _DOC
#define DP4C_ActivateErc(...) xXmRHDMAXXEQKNQijctW(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_ActivateOfflineWithFingerprint or \ref DPSDK_ActivateOfflineWithKey.
...
/*================= Activation Online =================*/
#ifndef _DOC
#define DP4C_ActivateEx(...) XLHjHuqFTUrzpaNUKyLM(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_ActivateOnlineWithFingerprint or \ref DPSDK_ActivateOnlineWithKey.
...
#ifndef _DOC
#define DP4C_ActivateXErc(...) bKPvznhendMjSnYJSinS(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_ActivateOnlineWithFingerprint or \ref DPSDK_ActivateOnlineWithKey.
...
/*================= Generate OTP =================*/
#ifndef _DOC
#define DP4C_GenPassword(...) zefJUZEgvtqFMxloPEVq(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_GenPasswordEx(...) LtDztesFBQZTxOqLcScL(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_GenerateResponseOnly, \ref DPSDK_GenerateResponseFromChallenge, \ref DPSDK_GenerateResponseOnlyWithKey or \ref DPSDK_GenerateResponseFromChallengeWithKey.
...
#ifndef _DOC
#define DP4C_GenPasswordEs(...) TZJYFxeDxVtOeQxecspD(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_GenPasswordEsEx(...) lJTHautRppnyUyzLUXnk(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_GenerateResponseOnlyES, \ref DPSDK_GenerateResponseFromChallengeES, \ref DPSDK_GenerateResponseOnlyESWithKey or \ref DPSDK_GenerateResponseFromChallengeESWithKey.
...
/*================= Generate Signature =================*/
#ifndef _DOC
#define DP4C_GenSignature(...) kozdovLOGBiRmaIWHvCs(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_GenSignatureEx(...) HsoQUKnRopVivErrCrpO(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_GenerateSignature or \ref DPSDK_GenerateSignatureWithKey.
...
#ifndef _DOC
#define DP4C_GenSignatureEs(...) ZoHEzmcvFpetRLDDzgNC(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_GenSignatureEsEx(...) vjpjqEJjVGeLsyOuZcEH(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_GenerateSignatureES or \ref DPSDK_GenerateSignatureESWithKey.
...
#define DP4CEBD_Activate(...) THSDrvZOjNqOwJcOeIUI(__VA_ARGS__)
...
#define DP4CEBD_ActivateEx(...) NwXKRxJkYCeDHCOLvkuv(__VA_ARGS__)
...
#define DP4CEBD_GenPassword(...) zqPLZHwrRGmBagTiArln(__VA_ARGS__)
...
#define DP4CEBD_GenSignature(...) ldEUOaPJQNszeBTBeFcP(__VA_ARGS__)
...
/*================= Get DP Info =================*/
#ifndef _DOC
#define DP4C_GetDPInfo(...) FYxlgDJjxChPRBtMDIjW(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_validPWD(...) RdRCLoDLPTEHBrNMOqNP(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_ValidatePasswordWithFingerprint. \warning Password validation is now managed by the DIGIPASS SDK during response generation.
...
/*================= Change PIN =================*/
#ifndef _DOC
#define DP4C_ChangePWD(...) DJioxIVdKZMCPthzsHTu(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_ChangePasswordWithFingerprint.
...
/*================= Change DVKey =================*/
#ifndef _DOC
#define DP4C_ChangeDVKey(...) PcyhiKyakNfEvVSwGzqL(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_isSVCorrect(...) wLhVIfownyJGBzWdQfAE(__VA_ARGS__)
#endif
//! \deprecated
SDK_IMPORT(vds_int32) DP4C_isSVCorrect( vds_byte	*i_bStaticVector);

#ifndef _DOC
#define DP4C_isSVCorrectEx(...) ovtcnkzWyFyqGAyRIGbC(__VA_ARGS__)
#endif
//! \deprecated
SDK_IMPORT(vds_int32) DP4C_isSVCorrectEx( vds_ascii	*i_StaticVector);

#ifndef _DOC
#define DP4C_vdsTDESCipher(...) EszAEfwreiWkMVDWLEqq(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_Encrypt(...) elsrGmWHjwqmpsLwbHoR(__VA_ARGS__)
#endif
//! \deprecated Use \ref DPSDK_Encrypt.
...
#ifndef _DOC
#define DP4C_Decrypt(...) JftrTYojvPotxyivUxtK(__VA_ARGS__)
#endif
...
#ifndef _DOC
#define DP4C_deriveMKInSV(...) dMNKdLtEdTybGfvSHfKZ(__VA_ARGS__)
#endif
//! \deprecated
...
/*================= Get Error Text =================*/
#ifndef _DOC
#define DP4C_GetErrorText(...) htmOipMmLNNWfeAPjSFi(__VA_ARGS__)
#endif
