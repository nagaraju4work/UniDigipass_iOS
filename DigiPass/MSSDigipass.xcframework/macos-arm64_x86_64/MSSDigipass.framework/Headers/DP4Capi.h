...
#define DIGIPASS_SDK_VERSION "4.30.1"                 //!< DIGIPASS SDK current version<br/><br/>
 ...
 * </ul>
 */
//! \deprecated This method has been deprecated and should not be used anymore
 ...
 * </ul>
 * ! \deprecated Use \ref DPSDK_Sha256Hash.
 */
...
#ifndef _DOC
#define DPSDK_Sha256Hash(...) ZIarbzqcIqVBEsLuFGcJk(__VA_ARGS__)
#endif
/**
 * Hash function which can be used during the integration to hash data.
 * \param dataIn Data to hash, MANDATORY, cannot be null
 ...
 * </ul>
 */
SDK_IMPORT(vds_int32) DPSDK_Sha256Hash(vds_byte* dataIn,
                                 vds_int32 dataInLength,
                                 vds_byte* dataOut,
                                 vds_int32* dataOutLength);
