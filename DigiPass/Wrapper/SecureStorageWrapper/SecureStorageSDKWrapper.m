...
//                                             }];
            ...
            [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperInit: %@",@"error SecureStorageSDKWrapper:initWithFileName.method"]];
...
- (BOOL)writeWithFingerprint:(NSString *)fingerPrint andIterationNumber:(int)iterationNumber error:(NSError**)error {
    ...
    return [_secureStorage writeWithFingerPrint:fingerPrint error:error];
...
//        }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperPutString: %@",@"error SecureStorageSDKWrapper:putWithString.method"]];
...
//                                         }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperPutBytes: %@",@"error SecureStorageSDKWrapper:putWithData.method"]];
...
//                                         }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperRemoveKey: %@",@"error SecureStorageSDKWrapper:removeValueWithKey.method"]];
...
//                                         }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperGetString: %@",@"error: SecureStorageSDKWrapper:getStringWithKey.method "]];
...
//                                         }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperGetBytes: %@",@"error: SecureStorageSDKWrapper:getDataWithKey.method "]];
...
//                                         }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperGetAll: %@",@"error: SecureStorageSDKWrapper:getAllAndReturnError.method "]];
...
//                                         }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperDeleteFileName: %@",@"error: SecureStorageSDKWrapper:deleteWithFileName.method "]];
...
//                                         }];
        ...
        [Logger log:[NSString stringWithFormat:@"SecureStorageSDKWrapperClear: %@",@"error: SecureStorageSDKWrapper:clearAndReturnError.method "]];
