...
const static string VERSION = "4.27.0";
...
public:
    ...
    static void encrypt(const unsigned char mechanism, const unsigned char mode, WBCSDKTables *wbcTables,
            unsigned char* initialVector, int initialVectorLength, unsigned char* dataIn,
                        int dataInLength, unsigned char* dataOut, int *dataOutLength);
    ...
    static void decrypt(const unsigned char mechanism, const unsigned char mode, WBCSDKTables *wbcTables,
            unsigned char * initialVector, int initialVectorLength, unsigned char * dataIn, int dataInLength,
            unsigned char * dataOut, int *dataOutLength);
