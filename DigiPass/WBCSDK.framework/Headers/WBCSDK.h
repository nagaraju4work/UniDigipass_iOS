...
const static string VERSION = "4.21.1";
...
public:
    ...
    static void encrypt(const unsigned char mechanism, const unsigned char mode, WBCSDKTables *wbcTables,
            unsigned char* initialVector, long int initialVectorLength, unsigned char* dataIn,
            long int dataInLength, unsigned char* dataOut, long int *dataOutLength);
    ...
    static void decrypt(const unsigned char mechanism, const unsigned char mode, WBCSDKTables *wbcTables,
            unsigned char * initialVector, long int initialVectorLength, unsigned char * dataIn, long int dataInLength,
            unsigned char * dataOut, long int *dataOutLength);
     ...
     * <br/>
     * They are exposed by the WBCSDK class.<br/>
     * <br/>
