...
@interface LegacySecureStorageSDK : NSObject
 ...
 * </ul>
 */
- (nullable instancetype)initWithFileName:(NSString * _Nonnull)filename useFingerPrint:(NSString * _Nullable)fingerprint andIterationNumber:(int32_t)iterationNumber error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (BOOL)writeWithFingerprint:(NSString * _Nullable)fingerprint andIterationNumber:(int32_t)iterationNumber error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (BOOL)putStringForValue:(NSString * _Nonnull)value forKey:(NSString * _Nonnull)key error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (BOOL)putBytesForBytes:(NSData * _Nonnull)value forKey:(NSString * _Nonnull)key error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (BOOL)removeForKey:(NSString * _Nonnull)key error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (NSString * _Nullable)getStringForKey:(NSString * _Nonnull)key error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (NSData * _Nullable)getBytesForKey:(NSString * _Nonnull)key error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (NSDictionary * _Nullable)getAllAndReturnError:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
+ (BOOL)deleteWithFileName:(NSString * _Nonnull)filename error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (BOOL)containsWithKey:(NSString * _Nonnull)key error:(NSError * _Nullable __autoreleasing * _Nullable)error NS_SWIFT_NOTHROW;
 ...
 * </ul>
 */
- (BOOL)clearAndReturnError:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * </ul>
 */
- (NSNumber * _Nullable)sizeAndReturnError:(NSError * _Nullable __autoreleasing * _Nullable)error;
...
/*!
 * \mainpage Secure Storage SDK - Programmer documentation
