...
const int DSAPPErrorCodes_DECRYPTED_DATA_INCORRECT_FORMAT = -4538;

/** Client ephemeral key null or empty.s */
...
/** Server verification message incorrect length. Length must be {@link DSAPPConstants_SRP_EVIDENCE_MESSAGE_LENGTH} characters */
...
/** MAC incorrect length. Length must be {@link DSAPPConstants_SRP_MAC_LENGTH} characters */
